...
public class SMCRPSchoolRecord extends Fragment  implements ConnectivityReceiver.ConnectivityReceiverListener{
    ...
    List<String> block_names=new ArrayList<>(),school_names=new ArrayList<>(),cluster_names=new ArrayList<>(),
            ...
            flag=new ArrayList<>();
    private SM_crp_submit_tables_school sbmit_details;
    SmCRPPruebaAdapterSchool adapter;
    Cursor submit;LinearLayout no_record;
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View view= inflater.inflate(R.layout.sm_crp_school_record, container, false);
        ...
        sbmit_details=new SM_crp_submit_tables_school(getContext());
        ...
        while (submit.moveToNext()) {
            school_names.add(submit.getString(2));
            cluster_names.add(submit.getString(1));
            remarks.add(submit.getString(4));
            dates.add(submit.getString(3));
            attendence_ids.add(String.valueOf(submit.getInt(0)));
            flag.add(String.valueOf(submit.getInt(5)));
        }
        ...
        adapter = new SmCRPPruebaAdapterSchool(school_names,dates,remarks,attendence_ids,flag);
