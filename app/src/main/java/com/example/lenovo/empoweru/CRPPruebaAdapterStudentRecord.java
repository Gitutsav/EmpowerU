...
public class CRPPruebaAdapterStudentRecord extends RecyclerView.Adapter<CRPPruebaAdapterStudentRecord.PruebaViewHolder> {

    List<String> school_names,cluster_names,dates,remarks,presents,absents,leaves,attendence_id,flag;
    AlertDialog.Builder builder1;
    String[] escrito;
private CRP_submit_tables_classes cstc;
ProgressDialog dialog;
    private Context context;

    public CRPPruebaAdapterStudentRecord(List<String> school_names, List<String> cluster_names
...
this.flag=flag;
    ...
    public PruebaViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.crp_student_status_item_row,parent,false);
        cstc=new CRP_submit_tables_classes(v.getContext());
    ...
    public void onBindViewHolder(PruebaViewHolder holder, int position) {
        ...
        String flags=flag.get(position);
         holder.bindProducto(schoolname,clustername,date,remak,present,absent,leave,attendence_ids,flags);
    }

    @Override
    public int getItemCount() {
        return cluster_names.size();
    }
    ...
    public class PruebaViewHolder extends RecyclerView.ViewHolder{
        ...
        double lattitudet,longitudet;String message,status;
       ...
       builder1.setNegativeButton(
        ...
        public void bindProducto(String schoolname, String clustername, String date, String remak, String present, String absent, String leave, final String attendence_id, String flag){
                ...
                sync.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if(isconnected){
                            ...
                            // Syncing part
                            Cursor res = cstc.getAllData11(Integer.parseInt(attendence_id));
                            Cursor rest=cstc.getAllData22(Integer.parseInt(attendence_id));
                         ...
                         //   Toast.makeText(view.getContext(),attendencestatust+"\n"+user_idt ,Toast.LENGTH_LONG ).show();
                            ...
                            nameValuePair.add(new BasicNameValuePair("markedtype", String.valueOf(2)));
                            ...
                            builder1.setPositiveButton(
                                    ...
                                    new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialog, int id) {
                                            ...
                                            cstc.update(Integer.parseInt(attendence_id));
                                                sync.setClickable(false);
                                                sync.setText("");
                                                sync.setLayoutParams(new LinearLayout.LayoutParams(40, 40));
                                                LinearLayout.LayoutParams lp = (LinearLayout.LayoutParams) sync.getLayoutParams();
