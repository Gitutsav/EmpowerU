...
public class SmCRPPruebaAdapterSchool extends RecyclerView.Adapter<SmCRPPruebaAdapterSchool.PruebaViewHolder> {
...
ProgressDialog dialog;
    public SmCRPPruebaAdapterSchool( List<String> school_names,List<String> dates, List<String> remarks, List<String> attendence_id, List<String> flag) {
    ...
    public PruebaViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.sm_crp_school_status_item_row,parent,false);
        this.bstt=new SM_crp_submit_tables_school(v.getContext());
    ...
    public void onBindViewHolder(PruebaViewHolder holder, int position) {
         ...
         holder.bindProducto(schoolname,date,remak,attendence_ids,flags);
    }

    @Override
    public int getItemCount() {
        return school_names.size();
    }
  ...
  /*          sync.setOnClickListener(new View.OnClickListener() {
       ...
       builder1.setNegativeButton(
        ...
        public void bindProducto(String schoolname, String date, String remak,  final String attendence_id, String flag){
                ...
                sync.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if(isconnected){
                            ...
                            nameValuePair.add(new BasicNameValuePair("mark_type", String.valueOf(2)));
