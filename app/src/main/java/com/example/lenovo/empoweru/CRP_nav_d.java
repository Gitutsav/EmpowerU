...
public class CRP_nav_d extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crp_nav_d);
        ...
        att.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(CRP_nav_d.this,SMCRP.class));
            }
        });
        ...
        profilet.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(CRP_nav_d.this,CRP_profile.class));
            }
        });
        ...
        profilel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(CRP_nav_d.this,CRPtabbedteacherq.class));
            }
        });
    ...
    private void setLayout() {
        ...
        drw= new Integer[]{R.drawable.hell, R.drawable.met, R.drawable.moto};
        for (int i = 0; i < 3; i++) {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.crp_nav_d, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
         startActivity(new Intent(CRP_nav_d.this,CRP_profile.class));
            ...
            startActivity(new Intent(CRP_nav_d.this,Helpline.class));
