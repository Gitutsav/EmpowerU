...
Cursor submit;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        sbmit_details=new Block_submit_tables_teachers(getContext());
        ...
        adapter = new BlockPruebaAdapter(block_names,school_names,cluster_names,dates,remarks,presents,absents,leaves,attendence_ids,flag);
