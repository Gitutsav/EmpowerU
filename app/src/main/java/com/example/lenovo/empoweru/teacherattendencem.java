...
public class teacherattendencem extends SQLiteOpenHelper{

    // Database Version
    private static final int DATABASE_VERSION = 1;

    // Database Name
    private static final String DATABASE_NAME = "teacherattendencep.db";
    private static final String TABLE1="teacherattendm";
    ...
    private static  String DATABASE_CREATE1 =
            "create table teacherattendm (attendence_id integer primary key autoincrement, "
    ...
    public teacherattendencem(Context context) {
...
*/
    ...
    public long inserttable2(Integer attendence_id,Integer user_id,Integer present_status,Integer flag){
        ...
        values.put("flag",flag);
      /*  values.put("attendence_id", 0);
        values.put("user_id",1);
        values.put("present_status",2);
        values.put("flag",3);*/
