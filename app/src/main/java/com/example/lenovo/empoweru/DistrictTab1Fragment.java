...
public class DistrictTab1Fragment extends Fragment  implements ConnectivityReceiver.ConnectivityReceiverListener{
    ...
    List<String> block_names=new ArrayList<>(),school_names=new ArrayList<>(),cluster_names=new ArrayList<>(),
            ...
            flag=new ArrayList<>();
private District_submit_tables_teachers sbmit_details;
DistrictPruebaAdapterTeacherRecord adapter;
Cursor submit;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view= inflater.inflate(R.layout.fragment_district_tab1, container, false);
        ...
        sbmit_details=new District_submit_tables_teachers(getContext());
        ...
        adapter = new DistrictPruebaAdapterTeacherRecord(block_names,school_names,cluster_names,dates,remarks,presents,absents,leaves,attendence_ids,flag);
