...
public class SM_District_submit_tables_school extends SQLiteOpenHelper {
    // Database Version

    private static final int DATABASE_VERSION = 1;

    // Database Name
    private static final String DATABASE_NAME = "sm_district_submit_db_teachers6.db";
    ...
    private static  String submit_5=
            "create table submit_table5(attendence_id integer , "+"category_id integer , "
                    + "my_image text ,"+"img_remark text);";
    public SM_District_submit_tables_school(Context context) {
