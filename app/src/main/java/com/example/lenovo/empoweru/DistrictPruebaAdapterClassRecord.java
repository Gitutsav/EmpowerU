...
public class DistrictPruebaAdapterClassRecord extends RecyclerView.Adapter<DistrictPruebaAdapterClassRecord.PruebaViewHolder> {
    private District_submit_tables_classes dstc;
...
ProgressDialog dialog;
    ...
    public DistrictPruebaAdapterClassRecord(List<String> block_names, List<String> school_names, List<String> cluster_names
    ...
    public PruebaViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        this.dstc=new District_submit_tables_classes(v.getContext());
                ...
                sync.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if(isconnected){
                            ...
                            dialog.show();
                            Cursor res = dstc.getAllData11(Integer.parseInt(attendence_id));
                            Cursor rest=dstc.getAllData22(Integer.parseInt(attendence_id));
                                    ...
                                    new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialog, int id) {
                                            ...
                                            if(status.equals("Success")) {
                                                dstc.update(Integer.parseInt(attendence_id));
                                                sync.setClickable(false);
                                                sync.setText("");
                                                sync.setLayoutParams(new LinearLayout.LayoutParams(40, 40));
                                                LinearLayout.LayoutParams lp = (LinearLayout.LayoutParams) sync.getLayoutParams();
