...
public class BlockPruebaAdapterClassRecord extends RecyclerView.Adapter<BlockPruebaAdapterClassRecord.PruebaViewHolder> {
    private Block_submit_tables_classes bstc;
...
ProgressDialog dialog;
    ...
    public BlockPruebaAdapterClassRecord(List<String> block_names, List<String> school_names, List<String> cluster_names
    ...
    public PruebaViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        this.bstc=new Block_submit_tables_classes(v.getContext());
    ...
    public class PruebaViewHolder extends RecyclerView.ViewHolder{
        ...
        String remarkt,datett,marked_ont,datet;String message,status,myimage;
                ...
                sync.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if(isconnected){
                            ...
                            // Syncing part
                            Cursor res = bstc.getAllData11(Integer.parseInt(attendence_id));
                            Cursor rest=bstc.getAllData22(Integer.parseInt(attendence_id));
                                    ...
                                    new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialog, int id) {
                                            ...
                                            if(status.equals("Success")) {
                                                bstc.update(Integer.parseInt(attendence_id));
                                                sync.setClickable(false);
                                                sync.setText("");
                                                sync.setLayoutParams(new LinearLayout.LayoutParams(40, 40));
                                                LinearLayout.LayoutParams lp = (LinearLayout.LayoutParams) sync.getLayoutParams();
