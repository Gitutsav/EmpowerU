...
public class SM_crp_submit_tables_school extends SQLiteOpenHelper {
    // Database Version

    private static final int DATABASE_VERSION = 1;

    // Database Name
    private static final String DATABASE_NAME = "sm_crp_submit_db_schools2.db";
    ...
    private static  String submit_1 =
            "create table  submit_table1(attendence_id integer primary key autoincrement, "
                    ...
                    +"datet text,"+"school_id integer,"+"school_name text,"+"cluster_name text,"+"remark text,"+"flag integer);";
    ...
    private static  String submit_3=
            "create table submit_table3(attendence_id integer,"+"cluster_name text,"+"school_name text,"+"datet text,"+"remark text,"+"flag integer);";
    ...
    private static  String submit_5=
            "create table submit_table5(attendence_id integer , "+"category_id integer , "
                    + "my_image text ,"+"img_remark text);";
    public SM_crp_submit_tables_school(Context context) {
