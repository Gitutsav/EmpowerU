...
public class DistrictTab3Fragment extends Fragment implements ConnectivityReceiver.ConnectivityReceiverListener{
    ...
    List<String> block_names=new ArrayList<>(),school_names=new ArrayList<>(),cluster_names=new ArrayList<>(),
            ...
            flag=new ArrayList<>();
    private District_submit_tables_classes sbmit_details;
   DistrictPruebaAdapterClassRecord adapter;
    Cursor submit;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        sbmit_details=new District_submit_tables_classes(getContext());
        ...
        adapter = new DistrictPruebaAdapterClassRecord(block_names,school_names,cluster_names,dates,remarks,presents,absents,leaves,attendence_ids,flag);
