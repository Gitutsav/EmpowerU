...
public class District_submit_tables_teachers extends SQLiteOpenHelper {
    // Database Version
    private static final int DATABASE_VERSION = 1;

    // Database Name
    private static final String DATABASE_NAME = "district_submit_db_teachers9.db";
    ...
    public District_submit_tables_teachers(Context context) {
