...
public class CRP_submit_tables_classes extends SQLiteOpenHelper {
    // Database Version
    private static final int DATABASE_VERSION = 1;

    // Database Name
    private static final String DATABASE_NAME = "crp_submit_db_student1.db";
    ...
    private static  String submit_1 =
            "create table  submit_table1(attendence_id integer primary key autoincrement, "
                    ...
                    +"datet text,"+"school_id integer,"+"school_name text,"
                    +"imgbase64 text,"+"cluster_name text,"+"remark text,"+"flag integer);";
    ...
    private static  String submit_3=
            "create table submit_table3(attendence_id integer,"+"school_name text,"+"cluster_name text,"+"present integer, "
                    + "absent integer ,"+"total integer,"+"datet text,"+"remark text,"+"flag integer);";
    public CRP_submit_tables_classes(Context context) {
    ...
    public long insersubmittable1(Double lat,Double longi,int accuracy,Integer slot_id,Integer taken_by,
                            String taken_on,String datet,Integer school_id
                                  , String cluster_name,String school_name,String imgbase64,String remark, Integer flag){
    ...
    public long insertsubmittable3(Integer attendence_id,Integer present,Integer absent,
                                  String cluster_name,String school_name,
