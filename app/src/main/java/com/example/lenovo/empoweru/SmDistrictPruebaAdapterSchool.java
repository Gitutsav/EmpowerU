...
public class SmDistrictPruebaAdapterSchool extends RecyclerView.Adapter<SmDistrictPruebaAdapterSchool.PruebaViewHolder> {
...
ProgressDialog dialog;
    public SmDistrictPruebaAdapterSchool(List<String> block_names, List<String> school_names, List<String> cluster_names
    ...
    public PruebaViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        this.bstt=new SM_District_submit_tables_school(v.getContext());
  ...
  /*          sync.setOnClickListener(new View.OnClickListener() {
       ...
       builder1.setNegativeButton(
        ...
        public void bindProducto(String blockname, String schoolname, String clustername, String date, String remak,  final String attendence_id, String flag){
                ...
                sync.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if(isconnected){
                            ...
                            nameValuePair.add(new BasicNameValuePair("mark_type", String.valueOf(4)));
