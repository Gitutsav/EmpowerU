...
public class DistrictPruebaAdapterTeacherRecord extends RecyclerView.Adapter<DistrictPruebaAdapterTeacherRecord.PruebaViewHolder> {
    private District_submit_tables_teachers dstt;
...
ProgressDialog dialog;
    ...
    public DistrictPruebaAdapterTeacherRecord(List<String> block_names, List<String> school_names, List<String> cluster_names
    ...
    public PruebaViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        this.dstt=new District_submit_tables_teachers(v.getContext());
                ...
                sync.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if(isconnected){
                            ...
                            // Syncing part
                            Cursor res = dstt.getAllData11(Integer.parseInt(attendence_id));
                            Cursor rest=dstt.getAllData22(Integer.parseInt(attendence_id));
                                    ...
                                    new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialog, int id) {
                                            ...
                                            if(status.equals("Success")) {
                                                ...
                                                dstt.update(Integer.parseInt(attendence_id));
                                            }
                                        }
                                    });
                        }
