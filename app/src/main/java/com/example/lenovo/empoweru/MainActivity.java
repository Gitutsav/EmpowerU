...
public class MainActivity extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener {
    ...
    Intent intent;
    android.widget.EditText uid, pwrd;
    String usid, pawrd;
...
Person person;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  Intent intent = new Intent(MainActivity.this, Dashboard.class);
       // startActivity(intent);
        ...
        // Toast.makeText(MainActivity.this,"ssrg"+mPhoneNumber,Toast.LENGTH_LONG).show();
       ...
       /* for (Account ac : accounts) {
            ...
            Toast.makeText(MainActivity.this,"Accounts : " + acname + ", " + actype,Toast.LENGTH_LONG).show();
        }
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (usid.isEmpty() || pawrd.isEmpty()) {
                    ...
                    if (isconnected) {
                        //dialog.cancel();
                     // Intent intent = new Intent(MainActivity.this, BLOCK_nav_d.class);
                     //startActivity(intent);
                      // OnLogin();
        ...
        protected void onPostExecute(String s) {
            ...
            if (first_char == 's') {
                ...
                if (second_char == '5') {
                    ...
                    new JSONTaskHM().execute("http://kasmmobileapp.empoweru.in/user_login/?username=" + usid + "&password=" + pawrd);

                    intent = new Intent(MainActivity.this, Dashboard.class);
                    //  Toast.makeText(MainActivity.this,s+"HEAD MASTER",Toast.LENGTH_LONG).show();
                    ...
                    editor.putString("password", pawrd);
                    editor.apply();
                    new JSONTaskCRP().execute("http://kasmmobileapp.empoweru.in/user_login/?username=" + usid + "&password=" + pawrd);
                     intent = new Intent(MainActivity.this, CRP_nav_d.class);
                     // Toast.makeText(MainActivity.this,s+"C.R.P.",Toast.LENGTH_LONG).show();
                    ...
                    new JSONTaskBlock().execute("http://kasmmobileapp.empoweru.in/user_login/?username=" + usid + "&password=" + pawrd);
                    intent = new Intent(MainActivity.this, BLOCK_nav_d.class);
                    //   Toast.makeText(MainActivity.this,s+"BLOCK",Toast.LENGTH_LONG).show();
                    ...
                    editor.putString("password", pawrd);
                    editor.apply();
                    new JSONTaskDistrict().execute("http://kasmmobileapp.empoweru.in/user_login/?username=" + usid + "&password=" + pawrd);
                    intent = new Intent(MainActivity.this, District_nav_d.class);
                    //   Toast.makeText(MainActivity.this,s+"BLOCK",Toast.LENGTH_LONG).show();
                   // dialog.cancel();
    ...
    public class JSONTaskCRP extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            //    Toast.makeText(MainActivity.this,"C.R.P."+loopeddata.toString(),Toast.LENGTH_LONG).show();
                for (int i = 0; i <parentArray3.length(); i++) {
                    JSONObject finalobject = parentArray3.getJSONObject(i);
                    String mq_name = finalobject.getString("mq_name");
                    int is_image = finalobject.getInt("is_image");
