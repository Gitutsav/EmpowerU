...
public class CRPPruebaAdapterTecher extends RecyclerView.Adapter<CRPPruebaAdapterTecher.PruebaViewHolder> {
    ...
    public CRPPruebaAdapterTecher(List<String> school_names, List<String> cluster_names
    ...
    public PruebaViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
       ...
       cstt=new CRP_submit_tables_teachers(v.getContext());
                ...
                sync.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if(isconnected){
                            ...
                            // Syncing part
                            Cursor res = cstt.getAllData11(Integer.parseInt(attendence_id));
                            Cursor rest=cstt.getAllData22(Integer.parseInt(attendence_id));
                                    ...
                                    new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialog, int id) {
                                            ...
                                            if(status.equals("Success")) {
                                                ...
                                                cstt.update(Integer.parseInt(attendence_id));
                                            }
                                        }
                                    });
                        }
