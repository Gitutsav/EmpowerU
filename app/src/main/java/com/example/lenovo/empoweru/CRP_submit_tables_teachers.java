...
public class CRP_submit_tables_teachers extends SQLiteOpenHelper {
    // Database Version
    private static final int DATABASE_VERSION = 1;

    // Database Name
    private static final String DATABASE_NAME = "crp_submit_db_teachers1.db";
    ...
    public CRP_submit_tables_teachers(Context context) {
