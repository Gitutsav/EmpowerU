...
public class BLOCK_nav_d extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {
TextView usernamet,levelt;String name,level;
LinearLayout empoweruweb;
FrameLayout sm,lelrel;
    private ImageButton profilel;
    private FlipperLayout flipperLayout;
    AlertDialog.Builder builder1,builder2;
    private TextView textView,textView2;
    private TextView att,letret;
    ImageButton atta,lere;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_block_nav_d);
       ...
       empoweruweb.setOnClickListener(new View.OnClickListener() {
        ...
        att.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(BLOCK_nav_d.this,SMBlockTabbed.class));
            }
        });
       ...
       sm.setOnClickListener(new View.OnClickListener() {
        ...
        letret=(TextView)findViewById(R.id.letret);
        lere=(ImageButton)findViewById(R.id.lere);
        lelrel=(FrameLayout)findViewById(R.id.lelrel);
        lelrel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(BLOCK_nav_d.this,BlockLeaveRecord.class));
            }
        });
        letret.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(BLOCK_nav_d.this,BlockLeaveRecord.class));
            }
        });
        lere.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(BLOCK_nav_d.this,BlockLeaveRecord.class));
            }
        ...
        profilel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(BLOCK_nav_d.this,fragmentTest.class));
            }
        });
     ...
     //   if (restoredText != null) {
      ...
      //  }
        ...
        profilet.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(BLOCK_nav_d.this,Block_profile.class));
            }
        });
...
*/
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.block_nav_d, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
          startActivity(new Intent(BLOCK_nav_d.this,Block_profile.class));
            ...
            startActivity(new Intent(BLOCK_nav_d.this,Helpline.class));
