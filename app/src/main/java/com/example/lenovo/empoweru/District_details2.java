...
public class District_details2 extends SQLiteOpenHelper {
    private static final int DATABASE_VERSION = 1;

    // Database Name
    private static final String DATABASE_NAME = "District6.db";
    ...
    private static  String user_details =
            "create table user_detailsl3 (name text, "+"designation text, "+"dob Context, "+"gender smallint, "
                    + "email text, "+"contact text,"+"role text,"+"district text,"+"adhaar text);";
    ...
    public static final String block_details =
            "CREATE TABLE " + " block_detailsl3" + "("
                    ...
                    + "block_id" + " INTEGER"
                    + ")";
    public District_details2(Context context) {
    ...
    public long inseruserdetails3(String names,String designations,String dob, int genders,
                                  ...
                                  String role, String district, long adhaar){
