...
public class District_submit_tables_classes extends SQLiteOpenHelper {
    // Database Version
    private static final int DATABASE_VERSION = 1;

    // Database Name
    private static final String DATABASE_NAME = "district_submit_db_student.db";
    ...
    private static  String submit_1 =
            "create table  submit_table1(attendence_id integer primary key autoincrement, "
                    ...
                    +"imgbase64 text,"+"block_name text,"+"cluster_name text,"+"remark text,"+"flag integer);";
    ...
    public District_submit_tables_classes(Context context) {
