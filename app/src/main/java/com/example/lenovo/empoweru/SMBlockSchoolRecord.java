...
public class SMBlockSchoolRecord extends Fragment  implements ConnectivityReceiver.ConnectivityReceiverListener{
    ...
    List<String> block_names=new ArrayList<>(),school_names=new ArrayList<>(),cluster_names=new ArrayList<>(),
            ...
            flag=new ArrayList<>();
private SM_Block_submit_tables_school sbmit_details;
SmBlockPruebaAdapterSchool adapter;
Cursor submit;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view= inflater.inflate(R.layout.sm_block_school_record, container, false);
        ...
        sbmit_details=new SM_Block_submit_tables_school(getContext());
        submit=sbmit_details.getAllData3();
        block_names.clear();school_names.clear();cluster_names.clear();
        ...
        adapter = new SmBlockPruebaAdapterSchool(block_names,school_names,cluster_names,dates,remarks,attendence_ids,flag);
