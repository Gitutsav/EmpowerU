...
public class HM_submit_tables_teachers extends SQLiteOpenHelper {
    // Database Version
    private static final int DATABASE_VERSION = 1;

    // Database Name
    private static final String DATABASE_NAME = "hm_submit_db_teachers5.db";
    ...
    private static  String submit_2=
            "create table submit_table2(attendence_id integer , "
                    + "teacher_id integer ,"+"present_status integer,"+"flag integer);";
    ...
    public HM_submit_tables_teachers(Context context) {
    ...
    public long insertsubmittable2(Integer attendence_id,Integer teacher_id,Integer present_status,Integer flag){
        // get writable database as we want to write data
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public Cursor getAllData1() {
       ...
       // Cursor res = db.rawQuery("SELECT * FROM submit_table1 WHERE attendence_id = "+ id+ " FROM submit_table1)",null);
        return res;
    }
